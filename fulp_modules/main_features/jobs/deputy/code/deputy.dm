...
/datum/id_trim/job/deputy
	...
	full_access = list(ACCESS_SECURITY, ACCESS_BRIG, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM)
	minimal_access = list(ACCESS_SECURITY, ACCESS_BRIG, ACCESS_MINERAL_STOREROOM)
	config_job = "deputy"
