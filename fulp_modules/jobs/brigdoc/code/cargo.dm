...
/datum/supply_pack/security/brigdoc_clothing
	...
	desc = "A beginner kit for aspiring Brig Physicians. Comes with a jumpsuit, jumpskirt, labcoat and beret. Medical sunglasses not included, comes with a Medical HUD instead. Requires Security access to open."
	cost = CARGO_CRATE_VALUE * 2
	access_view = ACCESS_SECURITY
	contains = list(/obj/item/storage/backpack/duffelbag/sec/brigdoc_equipment)
	crate_type = /obj/structure/closet/crate/secure
	crate_name = "brig physician kit crate"

/datum/supply_pack/security/brigdoc_clothing_plasma
	name = "Brig Physician Plasmaman Clothing Kit"
	desc = "A clothing kit for brig physicians, except for plasmamen! Comes with an envirosuit, an envirohelmet, labcoat, jackboots, white envirogloves and a Medical HUD. Requires Security access to open."
	cost = CARGO_CRATE_VALUE * 2
	access_view = ACCESS_SECURITY
	contains = list(/obj/item/storage/backpack/duffelbag/sec/brigdoc_equipment_plasma)
	crate_type = /obj/structure/closet/crate/secure
	crate_name = "brig physician plasmaman kit crate"
