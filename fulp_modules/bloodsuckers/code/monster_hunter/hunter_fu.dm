...
/*
 *	TG Updates changed how Martial arts work.
 *	When we update, use whats been coded below, it's already been tested on latest TG.
 *	Then delete this comment, because it's worthless.
 */
