/world/proc/update_status_fulp()
	...
	s+= "<b>[server_caption]</b>" // "<b>The Problems of the Future, <i>Today!</i></b>"  // "<b>[station_name()]</b>";	// FULPSTATION: We don't display the name of the Station anymore
	s += " ("
	...
	//s += "<br>Medium RP, New Antagonists"
