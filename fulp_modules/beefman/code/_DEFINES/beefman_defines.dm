...
// Names
GLOBAL_LIST_INIT(russian_names, world.file2list("fulp_modules/beefman/strings/fulp_russian.txt")) // Backtracked from names.dm
GLOBAL_LIST_INIT(experiment_names, world.file2list("fulp_modules/beefman/strings/fulp_experiment.txt")) // Backtracked from names.dm
GLOBAL_LIST_INIT(beefman_names, world.file2list("fulp_modules/beefman/strings/fulp_beefman.txt")) // Backtracked from names.dm
