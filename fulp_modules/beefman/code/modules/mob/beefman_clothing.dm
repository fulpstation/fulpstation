/obj/item/clothing/under/bodysash
	...
	icon = 'fulp_modules/beefman/icons/mob/clothing/beefclothing.dmi' // item icon
	worn_icon =  'fulp_modules/beefman/icons/mob/clothing/beefclothing_worn.dmi' // mob worn icon
	icon_state = "assistant" // Inventory Icon
	body_parts_covered = CHEST // |GROIN|ARMS
	lefthand_file = 'fulp_modules/beefman/icons/mob/clothing/beefclothing_hold_left.dmi'
	righthand_file = 'fulp_modules/beefman/icons/mob/clothing/beefclothing_hold_right.dmi'
