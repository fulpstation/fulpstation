...
/datum/species/beefman
	...
	deathsound = 'fulp_modules/beefman/sounds/beef_die.ogg'
	attack_sound = 'fulp_modules/beefman/sounds/beef_hit.ogg'
	special_step_sounds = list('fulp_modules/beefman/sounds/footstep_splat1.ogg','fulp_modules/beefman/sounds/footstep_splat2.ogg','fulp_modules/beefman/sounds/footstep_splat3.ogg','fulp_modules/beefman/sounds/footstep_splat4.ogg')//Sounds to override barefeet walkng
	grab_sound = 'fulp_modules/beefman/sounds/beef_grab.ogg'//Special sound for grabbing
	species_language_holder = /datum/language_holder/russian //--Speak Russian
	bodytemp_normal = T20C
	limbs_icon = 'fulp_modules/beefman/icons/mob/beefman_bodyparts.dmi'
...
/datum/species/beefman/disarm(mob/living/carbon/human/user, mob/living/carbon/human/target, datum/martial_art/attacker_style)
	...
	if (user == target)
		...
		if ((target_zone in allowedList) && affecting)
			...
			playsound(get_turf(user), 'fulp_modules/beefman/sounds/beef_hit.ogg', 40, 1)
		...
		if ((target_zone in allowedList))
			...
			spawn(1)
				if (do_mob(user,H))
					...
					newBP.attach_limb(H)
					newBP.give_meat(H, I)
					playsound(get_turf(H), 'fulp_modules/beefman/sounds/beef_grab.ogg', 50, 1)
...
/obj/item/bodypart/head/beef
	icon = 'fulp_modules/beefman/icons/mob/beefman_bodyparts.dmi'
	icon_greyscale = 'fulp_modules/beefman/icons/mob/beefman_bodyparts.dmi'
	icon_greyscale_robotic = 'fulp_modules/beefman/icons/mob/beefman_bodyparts_robotic.dmi'
