...
/datum/controller/subsystem/accessories/setup_lists()
	...
	eyes_beefman_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/beef/eyes)["default_sprites"]
	mouths_beefman_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/beef/mouth)["default_sprites"]
