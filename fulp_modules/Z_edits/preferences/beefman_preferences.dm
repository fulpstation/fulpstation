...
/datum/preference/choiced/beefman_eyes/init_possible_values()
	...
	var/icon/beef_head = icon('fulp_modules/main_features/beefmen/icons/mob/beefman_bodyparts.dmi', "beefman_head")
	...
	for (var/eye_name in GLOB.eyes_beefman)
		...
		icon_with_eye.Blend(icon('fulp_modules/main_features/beefmen/icons/mob/beefman_bodyparts.dmi', "m_beefeyes_[eyes.icon_state]_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/beefman_mouth/init_possible_values()
	...
	for (var/mouth_name in GLOB.mouths_beefman)
		...
		icon_with_mouth.Blend(icon('fulp_modules/main_features/beefmen/icons/mob/beefman_bodyparts.dmi', "m_beefmouth_[mouths.icon_state]_ADJ"), ICON_OVERLAY)
