...
/obj/machinery/light
	icon = 'fulp_modules/aesthetics/lights/icons/lighting.dmi'
	overlay_icon = 'fulp_modules/aesthetics/lights/icons/lighting_overlay.dmi'
...
/obj/machinery/light/proc/turn_on(trigger, play_sound = TRUE)
	...
	if(!matching)
		...
		if( prob( min(60, (switchcount**2)*0.01) ) )
			...
			if(play_sound)
				playsound(src.loc, 'fulp_modules/aesthetics/lights/sound/light_on.ogg', 65, 1)
