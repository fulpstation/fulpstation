/obj/item/stock_parts/cell
	icon = 'fulp_modules/aesthetics/cells/cell.dmi'
...
/obj/item/stock_parts/cell/update_overlays()
	...
	var/icon_link
	if(!grown_battery)
		icon_link = 'fulp_modules/aesthetics/cells/cell.dmi'
	else
...
/obj/machinery/cell_charger/update_overlays()
	...
	if(!charging.charging_icon)
		...
		.+= image('fulp_modules/aesthetics/cells/cell.dmi', charging.charging_icon)\
