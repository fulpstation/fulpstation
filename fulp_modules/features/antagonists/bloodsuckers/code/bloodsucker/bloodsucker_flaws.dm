...
/datum/antagonist/bloodsucker/proc/AssignClanAndBane()
	...
	switch(answer)
		if(CLAN_BRUJAH)
			my_clan = CLAN_BRUJAH
			to_chat(owner, span_announce("You are part of the Brujah Clan!\n\
		...
		if(CLAN_NOSFERATU)
			...
			to_chat(owner, span_announce("You are part of the Nosferatu Clan!\n\
		...
		if(CLAN_TREMERE)
			...
			to_chat(owner, span_announce("You are part of the Tremere Clan!\n\
		...
		if(CLAN_VENTRUE)
			...
			to_chat(owner, span_announce("You are part of the Ventrue Clan!\n\
