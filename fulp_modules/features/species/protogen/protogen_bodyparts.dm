/obj/item/bodypart/head/robot/protogen
	icon = 'fulp_modules/features/species/icons/mob/protogen_bodyparts.dmi'
	icon_greyscale = 'fulp_modules/features/species/icons/mob/protogen_bodyparts_greyscale.dmi'
