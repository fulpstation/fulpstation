...
/datum/preference/choiced/beefman_color/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features[FEATURE_BEEF_COLOR] = GLOB.color_list_beefman[value]

// Eyes
/datum/preference/choiced/species_feature/beefman_eyes
...
/datum/preference/choiced/species_feature/beefman_eyes/icon_for(value)
	...
	var/datum/sprite_accessory/eyes = get_accessory_for_value(value)
...
// Mouth
/datum/preference/choiced/species_feature/beefman_mouth
...
/datum/preference/choiced/species_feature/beefman_mouth/icon_for(value)
	var/datum/universal_icon/beef_head
	if(isnull(beef_head))
		beef_head = uni_icon('fulp_modules/icons/species/mob/beefman_bodyparts.dmi', "beefman_head")
		beef_head.blend_color("#d93356", ICON_MULTIPLY) // Make it red at least

	var/datum/sprite_accessory/mouths = get_accessory_for_value(value)
