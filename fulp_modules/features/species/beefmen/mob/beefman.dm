...
/datum/species/beefman
	...
	special_step_sounds = list('fulp_modules/features/species/sounds/footstep_splat1.ogg','fulp_modules/features/species/sounds/footstep_splat2.ogg','fulp_modules/features/species/sounds/footstep_splat3.ogg','fulp_modules/features/species/sounds/footstep_splat4.ogg')//Sounds to override barefeet walkng
	grab_sound = 'fulp_modules/features/species/sounds/beef_grab.ogg' //Special sound for grabbing
...
/datum/species/beefman/pre_equip_species_outfit(datum/job/job, mob/living/carbon/human/equipping, visuals_only = FALSE)
	...
	switch(job.title)
		...
		if("Chief Medical Officer")
			newSash = new /obj/item/clothing/under/bodysash/medical/cmo()
		if("Medical Doctor")
			newSash = new /obj/item/clothing/under/bodysash/medical()
		if("Chemist")
			newSash = new /obj/item/clothing/under/bodysash/medical/chemist()
		if("Virologist")
			newSash = new /obj/item/clothing/under/bodysash/medical/virologist()
		if("Paramedic")
			newSash = new /obj/item/clothing/under/bodysash/medical/paramedic()

		// Engineering
		if("Chief Engineer")
			newSash = new /obj/item/clothing/under/bodysash/engineer/ce()
		if("Station Engineer")
			newSash = new /obj/item/clothing/under/bodysash/engineer()
		if("Atmospheric Technician")
			newSash = new /obj/item/clothing/under/bodysash/engineer/atmos()
