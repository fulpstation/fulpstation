#define SAFETY_MOTH_ENGINEER "Engineering Safety Moth"
#define SAFETY_MOTH_MEDICAL "Medical Safety Moth"
#define SAFETY_MOTH_SECURITY "Security Safety Moth"
...
/datum/antagonist/ert/safety_moth
	...
	var/specialty = SAFETY_MOTH_ENGINEER
...
/datum/antagonist/ert/safety_moth/security
	...
	specialty = SAFETY_MOTH_SECURITY
...
/datum/antagonist/ert/safety_moth/greet()
	to_chat(owner, "<B><font size=3 color=green>You are the [specialty].</font></B>")
...
/obj/item/clothing/shoes/magboots/safety_moth
	desc = "A special pair of Magnetic boots which doesn't weight you down." // Do they even need this? They're a moth ffs.
