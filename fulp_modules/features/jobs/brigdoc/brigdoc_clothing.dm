...
/obj/item/clothing/head/fulpberet/brigphysician
	...
	armor = list(MELEE = 25, BULLET = 25, LASER = 20, ENERGY = 20, BOMB = 30, BIO = 50, FIRE = 50, ACID = 60, WOUND = 5)
...
/obj/item/clothing/suit/toggle/labcoat/armored
	...
	armor = list(MELEE = 25, BULLET = 25, LASER = 25, ENERGY = 30, BOMB = 20, BIO = 50, FIRE = 50, ACID = 50, WOUND = 10)
