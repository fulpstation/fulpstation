...
/datum/id_trim/job/deputy/supply
	...
	department_access = list(ACCESS_MAIL_SORTING, ACCESS_CARGO, ACCESS_MINING, ACCESS_MECH_MINING, ACCESS_MINING_STATION, ACCESS_MINERAL_STOREROOM, ACCESS_AUX_BASE, ACCESS_QM)
