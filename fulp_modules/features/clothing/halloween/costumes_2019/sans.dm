/obj/item/clothing/under/costume/sans
	...
	icon = 'fulp_modules/features/clothing/halloween/costumes_2019/sans_icon.dmi'
	worn_icon = 'fulp_modules/features/clothing/halloween/costumes_2019/sans_worn.dmi'
	icon_state = "sans"
