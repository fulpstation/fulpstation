...
/obj/item/clothing/head/power_ranger
	name = "ranger helmet"
	desc = "ranger helmet."
	icon = 'fulp_modules/features/clothing/halloween/costumes_2020/power_ranger_item.dmi'
	worn_icon = 'fulp_modules/features/clothing/halloween/costumes_2020/power_ranger_worn.dmi'
	icon_state = "red_helm"
	var/ranger
