/obj/item/clothing/under/gothlita_purple
	...
	icon = 'fulp_modules/features/clothing/halloween/costumes_2020/gothlita_purple_item.dmi'
	worn_icon = 'fulp_modules/features/clothing/halloween/costumes_2020/gothlita_purple_worn.dmi'
	icon_state = "dress"
