...
/obj/item/clothing/suit/werewolfdress
	...
	icon = 'fulp_modules/features/clothing/halloween/costumes_2020/werewolfdress_item.dmi'
	worn_icon = 'fulp_modules/features/clothing/halloween/costumes_2020/werewolfdress_worn.dmi'
