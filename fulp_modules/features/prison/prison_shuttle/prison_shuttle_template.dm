...
/datum/map_template/shuttle/prison/cleaning/special_start_objective()
	...
	addtimer(CALLBACK(src, .proc/send_more_trash), 21 SECONDS)
	addtimer(CALLBACK(src, .proc/send_more_trash), 22 SECONDS)
	addtimer(CALLBACK(src, .proc/send_more_trash), 23 SECONDS)
	addtimer(CALLBACK(src, .proc/send_more_trash), 24 SECONDS)
	addtimer(CALLBACK(src, .proc/send_more_trash), 25 SECONDS)
