...
export const MaterialCostSequence = (props: MaterialCostSequenceProps) => {
  const { design, amount, available, align, justify, MINERAL_MATERIAL_AMOUNT } =
    props;
  let { costMap } = props;
          ...
          <Flex direction={'column'} align="center">
            <Flex.Item>
              <MaterialIcon
                ...
                sheets={((amount || 1) * quantity) / MINERAL_MATERIAL_AMOUNT}
              />
            </Flex.Item>
            <Flex.Item
              style={
            ...
            >
              {formatSiUnit(
                ((amount || 1) * quantity) / MINERAL_MATERIAL_AMOUNT,
                0,
              )}
            </Flex.Item>
          </Flex>
