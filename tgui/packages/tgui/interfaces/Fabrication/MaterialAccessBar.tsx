...
export const MaterialAccessBar = (props: MaterialAccessBarProps) => {
  const { availableMaterials, MINERAL_MATERIAL_AMOUNT, onEjectRequested } = props;
...
const MaterialCounter = (props: MaterialCounterProps) => {
  const { material, onEjectRequested, MINERAL_MATERIAL_AMOUNT } = props;

  const [hovering, setHovering] = useState(false);

  const sheets = material.amount / MINERAL_MATERIAL_AMOUNT;
