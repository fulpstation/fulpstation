...
export const Fabricator = (props) => {
  ...
  const { fabName, onHold, designs, busy, MINERAL_MATERIAL_AMOUNT } = data;
...
const PrintButton = (props: PrintButtonProps) => {
  ...
  const { design, quantity, available, MINERAL_MATERIAL_AMOUNT } = props;
...
const Recipe = (props: RecipeProps) => {
  const { act } = useBackend<FabricatorData>();
  const { design, available, MINERAL_MATERIAL_AMOUNT } = props;
