          ...
          <Flex>
            ...
            <Flex.Item>
              <Box
                as="img"
                height="20px"
                src={resolveAsset(`pda.png`)}
              />
              To utilize your <b>PDA</b> uplink, enter the messenger tab and set the ringtone as the code you have been provided.
            </Flex.Item>
          </Flex>
          <Divider />
          <Flex>
            <Flex.Item>
              <Box
                as="img"
                height="20px"
                src={resolveAsset(`headset.png`)}
              />
              To utilize your <b>Headset</b> uplink, change its frequency to the frequency provided.
            </Flex.Item>
            <Divider vertical />
            <Flex.Item>
              <Box
                as="img"
                height="20px"
                src={resolveAsset(`pen.png`)}
              />
              To utilize the <b>pen</b> uplink, twist it to the first setting, then to the second one.
            </Flex.Item>
          </Flex>
          <Divider />
          <Flex>
            <Flex.Item>
              ...
              />
              To utilize the <b>internal uplink</b>, use the action button on the top left of your screen to access the uplink menu.
            </Flex.Item>
            <Divider vertical />
            <Flex.Item>
