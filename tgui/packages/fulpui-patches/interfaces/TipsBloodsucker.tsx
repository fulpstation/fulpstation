...
export const TipsBloodsucker = (props, context) => {
  ...
  const { name } = data;
  return (
    <Window width={400} height={450} theme="spookyconsole">
      <Window.Content>
        <Section>
          <Flex>
            <Flex.Item>
              ...
              <Box
                ...
                as="img"
                opacity={0.4}
                src={resolveAsset(`bloodsucker.png`)}
              />
            </Flex.Item>
          </Flex>
          <Divider />
          <Flex>
            <Flex.Item>
              You are a <b>Bloodsucker</b>, an undead blood-seeking monster living aboard Space Station 13.
            </Flex.Item>
            <Divider vertical />
            <Flex.Item>
          ...
          <Flex>
            <Flex.Item>
              ...
              />
              Fear the daylight! Solar flares will bombard the station periodically, and your coffin can guarantee your safety.
            </Flex.Item>
            <Divider vertical />
            <Flex.Item>
              <Box
          ...
          <Flex>
            <Flex.Item>
            Once you have a Coffin claimed, you will learn new structures in the <b>Tribal</b> section of your crafting menu.
            </Flex.Item>
            <Divider vertical />
            <Flex.Item>
              <Box
                as="img"
                height="20px"
                src={resolveAsset(`vassalrack.png`)}
              />
