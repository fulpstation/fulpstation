...
/obj/machinery/computer/arcade/battle/Reset()
	...
	if(SSevents.holidays && SSevents.get_holiday(HALLOWEEN))
	...
	else if(SSevents.holidays && SSevents.get_holiday(CHRISTMAS))
	...
	else if(SSevents.holidays && SSevents.get_holiday(VALENTINES))
