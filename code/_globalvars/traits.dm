...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_COLDBLOODED" = TRAIT_COLDBLOODED, // FULPSTATION BLOODSUCKERS EDIT
		"TRAIT_NONATURALHEAL" = TRAIT_NONATURALHEAL, // FULPSTATION BLOODSUCKERS EDIT
		"TRAIT_NORUNNING" = TRAIT_NORUNNING, // FULPSTATION BLOODSUCKERS EDIT
		"TRAIT_NOMARROW" = TRAIT_NOMARROW, // FULPSTATION BLOODSUCKERS EDIT
		"TRAIT_NOPULSE" = TRAIT_NOPULSE, // FULPSTATION BLOODSUCKERS EDIT
