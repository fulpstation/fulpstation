...
/datum/preferences/proc/load_character(slot)
	...
	// FULP EDIT - BEEFMAN
	proof_beefman_features(features)
	// FULP EDIT END
	...
	// FULP EDIT - BEEFMAN
	features["beefcolor"] = copytext_char(features["beefcolor"], 1, 7)
	features["beefeyes"] = sanitize_inlist(features["beefeyes"], GLOB.beefman_eyes_list)
	features["beefmouth"] = sanitize_inlist(features["beefmouth"], GLOB.beefman_mouth_list)
	// FULP EDIT END
...
/datum/preferences/proc/save_character()
	...
	// FULP EDIT - BEEFMAN
	WRITE_FILE(S["feature_beefcolor"], features["beefcolor"])
