...
/mob/living/simple_animal/hostile/asteroid/elite/pandora/proc/singular_shot_line(var/procsleft, angleused, turf/T)
	if(procsleft <= 0)
		return
...
/mob/living/simple_animal/hostile/asteroid/elite/pandora/proc/aoe_squares_2(var/turf/T, ring, max_size)
	if(ring > max_size)
		return
