...
/obj/item/clothing/suit/hooded/techpriest/armor/plate/Initialize(mapload)
	. = ..()
...
/obj/item/clothing/head/hooded/techpriest/armor/plate/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/armor_plate)
...
/obj/item/clothing/suit/hooded/techpriest/armor/lead/Initialize(mapload)
	. = ..()
...
/obj/item/clothing/head/hooded/techpriest/armor/lead/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/anti_magic, TRUE, TRUE, TRUE, ITEM_SLOT_OCLOTHING)
...
/obj/item/organ/cyberimp/chest/reviver/plus/on_life()
	if(reviving)
		if(owner.stat == UNCONSCIOUS)
			addtimer(CALLBACK(src, PROC_REF(heal)), 10) //Fast
		else
