...
/obj/item/reagent_containers/food/snacks/tatortot/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/dunkable, 10)
...
/obj/item/reagent_containers/food/snacks/chewable/lollipop/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/chewable/lollipop/cyborg/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/chewable/gumball/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/chewable/gumball/cyborg/Initialize(mapload)
	. = ..()
	addtimer(CALLBACK(src, PROC_REF(spamcheck)), 1200)
